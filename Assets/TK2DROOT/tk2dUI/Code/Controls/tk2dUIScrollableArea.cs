...
public class tk2dUIScrollableArea : MonoBehaviour
{
    ...
    [SerializeField]
    [HideInInspector]
    private tk2dUILayout
        backgroundLayoutItem = null;
    ...
    [SerializeField]
    [HideInInspector]
    private tk2dUILayoutContainer
        contentLayoutContainer = null;
    ...
    protected Vector3 swipeScrollingPressDownStartLocalPos = Vector3.zero;
    protected Vector3 swipeScrollingContentStartLocalPos = Vector3.zero;
    ...
    protected virtual void BackgroundButtonDown()
    {
    ...
    protected void BackgroundOverUpdate()
    {
        if (isBackgroundButtonDown)
        {
    ...
    protected virtual void BackgroundButtonRelease()
    {
